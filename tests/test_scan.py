...
def sample_logs():
    """L2 수준의 에이전트 로그 샘플."""
    return [
        {"event_type": "plan",    "payload": {"planning_depth": 12, "confidence": 0.75, "uncertainty": 0.10}},
        ...
        {"event_type": "plan",    "payload": {"planning_depth": 15, "confidence": 0.80, "uncertainty": 0.12}},
        {"event_type": "execute", "payload": {"action": "update_state"}},
        {"event_type": "observe", "payload": {"prediction_error": 0.11, "error_within_uncertainty": True, "goal_achieved": True}},
...
def sample_config():
    return {
        "laws_domain": "digital",
        "harness_rules": ["rule_1", "rule_2", "rule_3", "rule_4", "rule_5",
