...
| 항목 | 데이터 소스 |
|---|---|
| 총 블로그 포스트 수 | **14개** (POST 01~14, admin.html BLOG_POSTS 배열 하드코딩) |
...
| # | 파일 | 제목 |
|---|------|------|
| 14 | blog-agent-diagnostic-evolution.html | AI 에이전트 진단도구의 발전, HAchillesWorld 이전과 이후 |
...
> 다음 포스트 번호: **15** — `/blog-add` 스킬 실행 시 자동 업데이트됨
